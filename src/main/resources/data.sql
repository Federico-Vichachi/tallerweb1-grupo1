...
VALUES(1, 'Juan', 'Perez', 'juan.perez@test.com', '1122334455', 'Contrasenia@2025', 'juanperez', 'USUARIO_COMUN', 1, '/images/user.jpg', 999);
INSERT INTO Usuario(id, nombre, apellido, email, telefono, contrasenia, nombreDeUsuario, rol, domicilio_id, urlFotoDePerfil, puntos)
VALUES(2, 'Maria', 'Garcia', 'patitas@test.org', '3511223344', 'Contrasenia@2025', 'organizacionpatitas', 'ORGANIZACION', 2, '/images/user.jpg', 0);
INSERT INTO Usuario(id, nombre, apellido, email, telefono, contrasenia, nombreDeUsuario, rol, domicilio_id, urlFotoDePerfil, puntos)
VALUES(3, 'Carlos', 'Lopez', 'carlos.lopez@test.com', '3415556677', 'Contrasenia@2025', 'carlosveterinario', 'VETERINARIO', 3, '/images/user.jpg', 0);
...
VALUES(2, 'Se perdio Simon, gato atigrado', 'Gato macho de 3 anios, se perdio en Merlo.', 'Es un poco asustadizo pero muy docil. Tiene una mancha blanca en el pecho. Por favor, si lo ven, contactense.', '/images/sample/sample 2.jpg', 'Comun Europeo Atigrado', 5, 'BUENOS_AIRES','Merlo', 3511223344, 'maria.garcia@test.com', 2, '2023-10-26 18:00:00', -34.6855, -58.4905);
...
INSERT INTO Publicacion(id, titulo, descripcionCorta, descripcionDetallada, imagen, raza, tamanio, provincia, localidad, telefono, email, usuario_id, fechaPublicacion)
VALUES(3, 'Ayuda para la cirugia de Luna', 'Necesitamos recaudar fondos para operar a Luna.', 'Luna fue atropellada y necesita una cirugia compleja en su cadera. Cualquier ayuda, por pequenia que sea, nos acerca a la meta. ¡Gracias!', '/images/sample/sample 3.jpg', 'Galgo', 20, 'CORDOBA','Capital', 3511223344, 'maria.garcia@test.com', 2, '2023-10-25 12:00:00');
...
-- Publicacion 4: Salud
INSERT INTO Publicacion(id, titulo, descripcionCorta, descripcionDetallada, imagen, raza, tamanio, provincia, localidad, telefono, email, usuario_id, fechaPublicacion)
VALUES(4, 'Consulta sobre comportamiento canino', 'Mi perro ladra sin parar cuando me voy.', 'Es un caniche de 5 anios y sufre de ansiedad por separacion. ¿Algun consejo o recomendacion de un especialista en comportamiento en Rosario?', '/images/sample/sample 4.jpg', 'Caniche', 8, 'SANTA_FE','Santa Fe', 3415556677, 'carlos.lopez@test.com', 1, '2023-10-28 09:00:00');
