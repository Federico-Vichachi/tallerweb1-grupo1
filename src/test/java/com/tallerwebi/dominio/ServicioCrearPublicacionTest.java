...
public class ServicioCrearPublicacionTest {
    ...
    private RepositorioCrearPublicacion repositorioMock;
    private ServicioCrearPublicacion servicioCrearPublicacion;

    @BeforeEach
    public void setUp() {
        repositorioMock = mock(RepositorioCrearPublicacion.class);
        servicioCrearPublicacion = new ServicioCrearPublicacionImpl(repositorioMock);
    }
    ...
    public void siLosDatosDeLaPublicacionAdopcionSonCorrectosLaCreacionEsExitosa(){
        ...
        Publicacion2 publicacionAdopcion = whenCreoUnaPublicacionAdopcionCon("Adopto a Firulais", "Perro juguetón busca familia", "Firulais es un Golden Retriever de 3 años, muy cariñoso y activo. Ideal para familias con niños.", "firulais.jpg", "Golden Retriever", 40, "CABA, Argentina", 1145123412, "firulais@mail.com", 3 );
    ...
    private Publicacion2 whenCreoUnaPublicacionAdopcionCon(String titulo, String descripcionCorta, String descripcionDetallada, String imagen, String raza, int tamanio, String ubicacion, int telefono, String email, int edad) {
    ...
    private void thenLaCreacionDePublicacionAdopcionEsExitosa(Publicacion2 publicacion) {
    ...
    public void siLosDatosDeLaPublicacionRecaudacionSonCorrectosLaCreacionEsExitosa(){
        ...
        Publicacion2 publicacionRecaudacion = whenCreoUnaPublicacionRecaudacionCon("Campaña para operar a Pelusa", "Ayudanos a que Pelusa vuelva a correr.", "Pelusa es un perrito mestizo de 5 años que fue atropellado y necesita una cirugía urgente en su patita trasera.", "Pelusa.jpg", "Mestizo",50 , "Lanus, Argentina", 1145332211, "ayuda.rocky@gmail.com", 5, 150000.0, "0000003100035478292345", "Transferencia bancaria");
    ...
    private Publicacion2 whenCreoUnaPublicacionRecaudacionCon(String titulo, String descripcionCorta, String descripcionDetallada, String imagen, String raza, int tamanio, String ubicacion, int telefono, String email, int edad, double meta, String cbu, String metodoPreferido) {
    ...
    private void thenLaCreacionDePublicacionRecaudacionEsExitosa(Publicacion2 publicacion) {
        assertThat(publicacion, notNullValue());
    }
    ...
    private Publicacion2 whenCreoUnaPublicacionSaludCon(String titulo, String descripcionCorta, String descripcionDetallada, String imagen, String raza, int tamanio,  String ubicacion, int telefono, String email, int edad, String sintomasPrincipales, String diagnostico, String nivelUrgencia) {
    ...
    private void thenLaCreacionDePublicacionSaludEsExitosa(Publicacion2 publicacion) {
        assertThat(publicacion, notNullValue());
    }
    ...
    private Publicacion2 whenCreoUnaPublicacionPerdidoCon(String titulo, String descripcionCorta, String descripcionDetallada, String imagen, String raza, int tamanio, String ubicacion, int telefono, String email, String fechaDesaparicion, String horaDesaparicion, boolean llevaCollar, String recompensa) {
    ...
    private void thenLaCreacionDePublicacionPerdidoEsExitosa(Publicacion2 publicacion) {
        assertThat(publicacion, notNullValue());
    }
    ...
    private Publicacion2 whenCreoUnaPublicacionEncontradoCon(String titulo, String descripcionCorta, String descripcionDetallada, String imagen, String raza, int tamanio,String ubicacion, int telefono, String email) {
    ...
    private void thenLaCreacionDePublicacionEncotradoEsExitosa(Publicacion2 publicacion) {
        assertThat(publicacion, notNullValue());
    }
}
